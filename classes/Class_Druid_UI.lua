...
function M:BuildBody(ui, parent)
    ...
    ui:Tip(self.swipeRow.cb, "Swipe (AoE)", "When on, Swipe leads the priority for multi-target threat.", "Manual toggle, also /sbr aoe. Leave it off on a single target: Swipe costs 20 rage that Maul would turn into more threat on the one mob.")
